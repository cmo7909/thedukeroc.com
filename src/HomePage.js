...
function HomePage() {
  return (
    <div className='info-box'>
      <p className='info-text'>The Duke offers modern amenities in a unique and historic location in downtown
      Rochester, NY. The Aesthetic is inspired by the raw music lifestyle of New York City in
      the late 20 th century. The Duke features a custom leather fringe chandelier, bold lighting
      and art accents throughout, and a tiled concert stage that looks out over East Main
      Street and Parcel 5.<br /><br />
      ...
      cocktails, while immersing yourself in a creative one-of-a-kind venue.</p>
    </div>
  );
}
